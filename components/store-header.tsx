...
export function StoreHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/70 backdrop-blur border-b">
      ...
      {/* SIDE DRAWER */}
      {menuOpen && (
        <div className="fixed inset-0 z-9999 h-full w-full">
          {/* overlay */}
          <div
          ...
          {/* drawer */}
          {/* <div className="absolute left-0 top-0 h-full w-80 bg-white dark:bg-gray-900 shadow-xl flex flex-col"> */}
          <div className="fixed left-0 top-0 h-full w-80 bg-white dark:bg-gray-900 shadow-xl flex flex-col">
